...
class EfMigrationHistoryMapApi(models.Model):
...
class EventTypePositionMapApi(models.Model):
...
class Location(models.Model):
    id = models.UUIDField(db_column='Id', primary_key=True)  # Field name made lowercase.
    gameid = models.OneToOneField(GameMapApi, models.DO_NOTHING, db_column='GameId')  # Field name made lowercase.
...
class ProcessedEventMapApi(models.Model):
    id = models.UUIDField(db_column='Id', primary_key=True)  # Field name made lowercase.
